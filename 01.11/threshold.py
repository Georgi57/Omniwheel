...
while True:
    ...
    if obj<3 or obj >4:
        ...
        cv.InRangeS(frame, (currentcolors[0], currentcolors[1], currentcolors[2]), (currentcolors[3], currentcolors[4], currentcolors[5]), thresholded_frame) 
    cv.Smooth(thresholded_frame, thresholded_frame, cv.CV_BLUR, 3);
    
    cv.ShowImage("webcam", hsv_frame)
